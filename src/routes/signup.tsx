...
export const Route = createFileRoute("/signup")({
  head: () => ({
    meta: [
      { title: "Join — Chaplin's Party of India" },
      {
        name: "description",
        content:
          "Sign up to become a member of Chaplin's Party of India. Build ideology before influence.",
      },
    ],
  }),
      ...
      <div className="relative z-10 w-full max-w-lg px-6">
        ...
        <div className="mb-10">
          ...
          <h1 className="font-display text-4xl md:text-5xl leading-[0.92] tracking-[-0.04em]">
            Join the
            <br />
            <span className="text-fog">movement.</span>
          </h1>
          <p className="mt-4 text-sm text-muted-foreground leading-relaxed max-w-sm">
            Create your account. Every member is a student of society.
          </p>
        </div>
